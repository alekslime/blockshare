    ...
    modal.innerHTML = `
      <div class="modal-content block-appear">
        ...
        <div class="modal-body">
          <p>To enable Google ${mode === "signin" ? "Sign-In" : "Sign-Up"}, you need to set up a Google OAuth client ID:</p>
          ...
          <p class="demo-note">Or click "Use Demo Mode" below to instantly log in with a demo account!</p>
        </div>
